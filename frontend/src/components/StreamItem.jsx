        ...
        <div className='relative'>
            ...
            <div
                ...
                <div id='card__live' className='flex flex-row justify-between p-2'>
                    ...
                    <div className='py-0.5 px-1.5 bg-slate-600/75 text-white rounded-md'>
                        {' '}
                ...
                <div
                    ...
                    <div className='px-2 text-xl w-14 h-14 flex ml-1'>
                        <img
                            ...
                            className='min-w-10 h-10 rounded-full m-auto'
                        />
                    </div>
                    <div className='flex-grow overflow-hidden px-1 py-2'>
                        <span className='text-md md:text-sm text-slate-600'>
                            {stream.channel_name}
                        </span>
