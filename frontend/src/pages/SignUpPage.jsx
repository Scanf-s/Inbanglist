...
const inputStyle =
    'h-12 p-2 w-full border border-solid border-slate-300 rounded-md text-sm dark:bg-[#09203f] dark:text-[#f5f7fa]';
        ...
        <div className='h-screen w-screen bg-gradient-to-br from-[#f5f7fa] to-[#c3cfe2] dark:from-[#537895] dark:to-[#09203f]'>
            <div className='fixed h-full w-full'>
                <div className='flex h-full justify-center items-center'>
                    <form
                        className='w-[calc(100%-40px)] max-w-[440px] p-[50px] bg-white dark:bg-[#09203f] border dark:border-[#09203f] rounded-xl shadow-md'
                        ...
                        <button
                            className='my-7 w-full h-12 text-lg bg-[#929EAD] text-white dark:text-black rounded-md hover:bg-[#BCC5CE]'
                            type='submit'
                            name='submit'>
                            회원가입
                        </button>
                        <div className='flex justify-center gap-1 text-sm dark:text-[#c3cfe2]'>
                            <p>이미 회원이신가요?</p>
                            <Link to='/login' className='text-[#929EAD] font-bold underline'>
                                로그인
                            </Link>
                        </div>
                    </form>
