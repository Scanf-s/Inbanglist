...
class UserRegisterAPITest(TestCase):
    def setUp(self):
        ...
        self.user1 = {"email": "calzone0404@gmail.com", "password": "123456", "password_verify": "123456"}
        self.user2 = {"email": "sullung2yo@gmail.com", "password": "123456", "password_verify": "123456"}
